# Python Security Reference (Django, Flask, FastAPI)

Routing map: which OWASP Cheat Sheets to fetch for Python projects.
...
Load these additionally when the framework is detected:
...
- Imports: `django`, `flask`, `fastapi`, `sqlalchemy`, `requests`

## Package Ecosystem for OSV.dev

When verifying packages, use ecosystem: `PyPI`
