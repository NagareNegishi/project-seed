# Java Security Reference (Spring Boot, Jakarta EE)

Routing map: which OWASP Cheat Sheets to fetch for Java projects.
...
Detect Java projects by presence of:
- `*.java` files
- `pom.xml`, `build.gradle`, `build.gradle.kts`
- `*.jar`, `*.war` files
- Imports: `org.springframework`, `jakarta.`, `javax.`

## Package Ecosystem for OSV.dev

When verifying packages, use ecosystem: `Maven`
