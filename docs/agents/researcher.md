...
- Resolved: a separate [verifier](verifier.md) agent now exists to re-check each
  reference in a researcher report; the fixed report structure feeds it directly.
